    ...
    <div class="bg-white py-2 px-4">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 lg:gap-x-12 gap-y-8 items-center">
          ...
          <div class="flex flex-col items-center md:items-start space-y-2 col-span-1 lg:col-span-1 md:col-span-1">
            <div class="w-48 h-48 md:w-64 md:h-64 flex items-center justify-center md:justify-start">
              <img :src="logo" alt="Anugerah Auto" class="w-full h-full object-contain" />
            </div>
          </div>

          <div class="flex flex-col h-full justify-center items-center md:items-start text-center md:text-left">
          ...
          <div class="flex flex-col h-full justify-center items-center md:items-start text-center md:text-left">
            <div class="flex items-start gap-2 mb-4"> 
              ...
              <div class="text-gray-800 text-sm md:text-base text-left md:text-left">
                <p class="font-semibold leading-snug">{{ L.schedule }}</p>
                <p class="text-sm leading-snug">{{ L.scheduleHelper }}</p>
              </div>
            </div>
            <div class="w-full max-w-xs h-32 rounded-lg overflow-hidden">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.869893758414!2d106.8585981!3d-6.1481706!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6a1f05680f3797%3A0x77463fa474ce30e1!2sAnugerah%20Auto%20Sunter!5e0!3m2!1sid!2sid!4v1763107020663!5m2!1sid!2sid" 
                width="100%" 
                height="100%" 
                style="border:0;" 
                allowfullscreen="" 
          ...
          <div class="flex flex-col h-full justify-center items-center md:items-end">
            <div class="text-center md:text-right">
              ...
              <a 
                ...
                class="inline-block border-2 border-brand-blue text-brand-blue px-6 py-2 rounded-full font-semibold hover:bg-brand-blue hover:text-white transition-colors"
              >
                {{ L.lihatRute }}
              </a>
            </div>
